...
var applyLoan = httpUrl + "/wechat/product/applyLoan.json";
...
function showTipMessage(message,flag) {
    layer.alert(message,{icon:2,yes:function(index){
        if (flag) {
            window.location.href = "/static/recommend/index.html";
        }else{
            layer.close(index);
        }
    }});
}
function viewDetail(id,channelNo) {
    window.location.href="/static/recommend/productDetail.html?id="+id+"&channelNo="+channelNo;
}
var sendTime =60;
function leftTimer() {
    sendTime--;
